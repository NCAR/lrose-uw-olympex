...
$RAW_DIR = "/home/disk/bob/olympex/raw/d3r_qc/ku";
$TMP_DIR = $RAW_DIR."/tmp";
...
@dates = ("20151201");
#@dates = ("20151114","20151115","20151116","20151117","20151118","20151119",
...
for $idate (0..$#dates) {
    ...
    print "Processing ",$RAW_DIR."/".$dates[$idate];

    $last_sweep = 0;
    $first_file = 1;
    foreach $file (<olympex_d3r_ku*.nc>) {
	print "file = $file\n";

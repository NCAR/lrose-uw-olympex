...
$RAW_DIR = "/home/disk/bob/olympex/raw/d3r_qc/ka/sur";
$TMP_DIR = $RAW_DIR."/tmp";
$PARAM_DIR = "~meso/olyProjDir/ingest/params";
$BIN_DIR = "/home/disk/meso-home/meso/lrose/bin";
$OUT_DIR = "/home/disk/bob/olympex/cfradial/moments/d3r_ka_qc/sur";
...
for $idate (0..$#dates) {
	...
	if ($sweep > $last_sweep) {
	    ...
	    $command = "$BIN_DIR/RadxConvert -params $PARAM_DIR/RadxConvert.d3r.ka.archive.sur -f $TMP_DIR/*.nc";
	    print "   command = $command\n";
	    system($command);

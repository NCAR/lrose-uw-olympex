...
$RAW_DIR = "/home/disk/bob/olympex/raw/d3r_qc/ku/rhi";
$TMP_DIR = $RAW_DIR."/tmp";
$PARAM_DIR = "~meso/projDir/ingest/params";
#$BIN_DIR = "/home/disk/meso-home/meso/cvs/bin";
$BIN_DIR = "/home/disk/blitz/bin";
$OUT_DIR = "/home/disk/bob/olympex/cfradial/moments/d3r_ku_qc/rhi";
...
for $idate (0..$#dates) {
	...
	if ($sweep > $last_sweep) {
	    ...
	    $command = "$BIN_DIR/RadxConvert -params $PARAM_DIR/RadxConvert.d3r.ku.archive.rhi -f $TMP_DIR/*.nc";
